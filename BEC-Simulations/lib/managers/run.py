        ...
        json.dump(
            {
                ...
                "simulator": CNModule.__CN_MODULE_NAME__,
            },
            f,
            indent=4,
        )
...
def getSimulatorModule(CNModPath: str = None):
    if CNModPath:
        ...
        mod = SourceFileLoader("module", CNModPath).load_module()
        mod.__CN_MODULE_NAME__ = CNModPath
        return mod
    else:
        CNdefault.__CN_MODULE_NAME__ = CNdefault.__file__
        return CNdefault
